...
/** INTERNAL API */
private[akka] abstract class UnfoldFlowGraphStageLogic[O, S, E] private[stream] (shape: FanOutShape2[O, S, E],
                                                                                 seed: S,
                                                                                 timeout: Timeout)
...
/** INTERNAL API */
private[akka] class FanOut2unfoldingStage[O, S, E] private[stream] (
